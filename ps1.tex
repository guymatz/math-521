...
\\
Induction on $n$\\
Base Step: n = 2, See (b) above.
\\
Induction Hypothesis:
\\$(A_1 \cap A_2 \cap \dots \cap A_n)^c = A_1^c \cup A_2^c \cup \dots \cup A_n^c$
\\Induction Step:\\
$(A_1 \cap A_2 \cap \dots \cap A_{n+1})^c = A_1^c \cup A_2^c \cup \dots \cup A_{n+1}^c$\\
Or, $(A_1 \cap A_2 \cap \dots \cap A_n)^c \cup A_{n+1} = A_1^c \cup A_2^c \cup \dots \cup A_{n+1}^c$\\
Let $B = (A_1 \cap A_2 \cap \dots \cap A_{n})$\\
and $B'= A_1^c \cup A_2^c \cup \dots \cup A_{n}^c$\\
Our Induction then becomes:
%$(
...
\\Induction Step:\\
$(A_1 \cup A_2 \cup \dots \cup A_{n+1})^c = A_1^c \cap A_2^c \cap \dots \cap A_{n+1}^c$\\
Or, $(A_1 \cup A_2 \cup \dots \cup A_n)^c \cap A_{n+1} = A_1^c \cap A_2^c \cap \dots \cap A_{n+1}^c$\\
Let $B = (A_1 \cup A_2 \cup \dots \cup A_{n})$\\
and $B'= A_1^c \cap A_2^c \cap \dots \cap A_{n}^c$\\
Our Induction then becomes:
%$(
